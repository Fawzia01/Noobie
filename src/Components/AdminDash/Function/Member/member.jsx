...
import {
  ...
  Paper, Typography, Avatar, IconButton, InputAdornment, Tooltip
} from "@mui/material";
...
const Member = () => {
  ...
  const handleAddMember = () => {
    console.log("New member data:", newMember); // Add this line for debugging
    ...
    axios
      ...
      .then((response) => {
        ...
        //setFilteredMembers((prevMembers) => [...prevMembers, response.data]);
  ...
  const handleDeleteMember = () => {
    ...
    axios
      ...
      .then(() => {
        // Remove the deleted member from both the members and filteredMembers states
        ...
        <div className="member-container">
          ...
          <TableContainer component={Paper} className="member-table-container">
            <Table>
              <TableHead>
                <TableRow>
                  {["ID", "Name", "Department", "Address", "Email", "Batch", "Interest", "Action"].map(
                    (header) => (
              ...
              <TableBody>
                {filteredMembers.map((member) => (
                  <TableRow key={member.id}>
                    ...
                    <TableCell>
                      <Tooltip title="Edit">
                        <IconButton onClick={() => handleEditDialogOpen(member)}  color="primary">
                          Edit 
                        </IconButton>
                      </Tooltip>
        ...
        <DialogContent>
          {[
            ...
            <TextField
              ...
              onChange={(e) =>
                setMemberToEdit((prev) => ({ ...prev, [key]: e.target.value }))
              }
              fullWidth
              margin="normal"
            />
